...
/*   Updated: 2022/12/19 12:48:24 by ebrodeur         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	move_forward(t_cub *cub)
{
	...
	if (cub->data.map[cub->collision.ym_pos][cub->collision.xo_add] == '0')
		cub->posx += cub->pdx;
	if (cub->data.map[cub->collision.yo_add][cub->collision.xm_pos] == '0')
		cub->posy += cub->pdy;
}
...
void	move_backward(t_cub *cub)
{
	...
	if (cub->data.map[cub->collision.ym_pos][cub->collision.xo_sub] == '0')
		cub->posx -= cub->pdx;
	if (cub->data.map[cub->collision.yo_sub][cub->collision.xm_pos] == '0')
		cub->posy -= cub->pdy;
}
...
void	move_right(t_cub *cub)
{
	...
	if (cub->data.map[cub->collision.ym_pos][cub->collision.xo_right] == '0')
		cub->posx += -cub->pdy;
	if (cub->data.map[cub->collision.yo_right][cub->collision.xm_pos] == '0')
		cub->posy += cub->pdx;
}
...
void	move_left(t_cub *cub)
{
	...
	if (cub->data.map[cub->collision.ym_pos][cub->collision.xo_left] == '0')
		cub->posx += cub->pdy;
	if (cub->data.map[cub->collision.yo_left][cub->collision.xm_pos] == '0')
		cub->posy += -cub->pdx;;
}
