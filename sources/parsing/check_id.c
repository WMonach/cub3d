...
/*   Updated: 2022/12/23 08:55:07 by ebrodeur         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	check_rgb_id(t_data *data, int i)
{
	char	*str;
	int		j;
	...
	{
		printf("Error : wrong ID for Floor [F] or Ceiling [C]\n");
		data->check_rgb_id = 1;
		return (1);
	}
	return (0);
